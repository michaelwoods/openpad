...
describe("POST /api/generate", () => {
  ...
  test("should use Gemini by default", async () => {
    ...
    expect(llm.generateWithGemini).toHaveBeenCalledWith(
  ...
  test("should use Ollama when provider is ollama", async () => {
    ...
    expect(llm.generateWithOllama).toHaveBeenCalledWith(
      expect.objectContaining({
  ...
  test("should use OpenAI when provider is openai", async () => {
    ...
    expect(llm.generateWithOpenAI).toHaveBeenCalledWith(
      expect.objectContaining({
